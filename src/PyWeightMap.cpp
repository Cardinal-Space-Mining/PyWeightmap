...
PYBIND11_MODULE(PyWeightMap, m) {
    ...
    border_place.def("__or__", [](const BorderPlace& a, const BorderPlace& b){return a | b;});

    //Path Utility
    m.def("compress_path", [](WeightMap::path_t path){ 
    ...
    SmoothPathDocString
    , py::arg("path"), py::arg("smoothing_val"));
    ...
    //Static Data
    py_wm.def_property_readonly_static("max_weight", [](py::object /* self */){ return WeightMap::getMaxWeight(); }, "The maximum weight that a WeightMap can hold"); //Going through lambda is necessary if it does not take arguements
    py_wm.def_property_readonly_static("min_weight", [](py::object /* self */){ return WeightMap::getMinWeight(); }, "The minimum weight a WeightMap can hold");

    //Weight setter and getter
    py_wm.def("get_weight", [](WeightMap& self, py::int_ x, py::int_ y){ return self.getWeight(mapsizeTFromPyInt(x), mapsizeTFromPyInt(y));}, 
    GetWeightDocString, 
    py::arg("x"), py::arg("y"));

    py_wm.def("set_weight", [](WeightMap& self, py::int_ x, py::int_ y, py::int_ weight){ return self.setWeight(mapsizeTFromPyInt(x), mapsizeTFromPyInt(y), mapsizeTFromPyInt(weight));}, 
    SetWeightDocString,
    py::arg("x"), py::arg("y"), py::arg("weight"));

    //PathPlanning
    py_wm.def("get_path", [](WeightMap& self, py::int_ src_x, py::int_ src_y, py::int_ dst_x, py::int_ dst_y){ return self.getPath(mapsizeTFromPyInt(src_x), mapsizeTFromPyInt(src_y), mapsizeTFromPyInt(dst_x), mapsizeTFromPyInt(dst_y));}, 
    GetPathDocString, 
    py::arg("src_x"), py::arg("src_y"), py::arg("dst_x"), py::arg("dst_y"));
    
    py_wm.def("path_to_x", [](WeightMap& self, py::int_ src_x, py::int_ src_y, py::int_ dst_x){ return self.pathToXVal(mapsizeTFromPyInt(src_x), mapsizeTFromPyInt(src_y), mapsizeTFromPyInt(dst_x));}, 
    PathToXDocString, 
    py::arg("src_x"), py::arg("src_y"), py::arg("dst_x"));

    py_wm.def("add_border", [](WeightMap& self, py::int_ width, py::int_ weight, BorderPlace place){return self.addBoarder(mapsizeTFromPyInt(width), mapsizeTFromPyInt(weight), place);}, 
    AddBorderDocString,
    py::arg("border_width"),py::arg("border_weight"),py::arg("border_place"));

    py_wm.def("add_obstical", [](WeightMap& self, py::int_ x, py::int_ y, py::int_ radius, py::int_ weight, bool gradient){return self.addObstical(mapsizeTFromPyInt(x), mapsizeTFromPyInt(y), mapsizeTFromPyInt(radius), mapsizeTFromPyInt(weight), gradient);}, 
    ...
    py_wm.def(py::pickle(
        [](const WeightMap & wm) { // __getstate__
